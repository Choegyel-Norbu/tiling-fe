...
export function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    // If no errors, open email client with pre-filled data
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:drdrinchhendorji@gmail.com" className="text-sm text-accent font-semibold hover:underline">drdrinchhendorji@gmail.com</a>
                </div>
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  />
                  <User className={`absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 ${errors.name ? 'text-red-400' : 'text-slate-400'}`} />
                </div>
                {errors.name && (
                ...
                <div className="relative">
                  <input 
                    ...
                    className={`w-full px-4 py-3 pl-11 rounded-xl border-2 transition-all duration-200 bg-white/80 backdrop-blur-sm
                      ...
                      placeholder:text-slate-400 text-slate-900 focus:bg-white`}
                  />
                  <Mail className={`absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 ${errors.email ? 'text-red-400' : 'text-slate-400'}`} />
                </div>
                {errors.email && (
                  <p className="text-red-500 text-xs font-medium flex items-center gap-1 ml-1">
